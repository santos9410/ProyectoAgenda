$(document).ready(function() {
  ...
  $('.formModificar').submit(function(e) {
     e.preventDefault();
      ...
      //    }
         guardarContacto(id,nombre,dir,tel,email,cp,edad,gustos);
...
function guardarContacto(id,nombre,dir,tel,email,cp,edad,gustos){
  console.log(id+nombre+dir+tel,email+cp+edad+gustos);
  $.ajax({
      // En data puedes utilizar un objeto JSON, un array o un query string
     //  data: {"noControl":control,"nombre":numero},
       data: {"id":id,"nombre":nombre,"dir":dir,"tel":tel,"email":email,"cp":cp,"edad":edad,"gustos":gustos},
      //Cambiar a type: POST si necesario
      type: "POST",
      // Formato de datos que se espera en la respuesta
      dataType: "json",
      // URL a la que se enviará la solicitud Ajax
      url: "controlers/ModificarContacto.php",
  })
